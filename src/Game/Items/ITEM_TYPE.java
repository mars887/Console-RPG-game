...
public enum ITEM_TYPE {
    ...
    HEALING_POTION_15HP("зелье востановления 15НР", 30, 50, 3,true),
    HEALING_POTION_40HP("зелье востановления 40НР", 80, 240, 2,true),
    DEXTERITY_POTION("зелье ловкости", 24, 40, 3,true);

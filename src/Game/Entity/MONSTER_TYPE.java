...
public enum MONSTER_TYPE {
    ZOMBIE("зомби", 100, 10, 0.7f, 1, ITEM_TYPE.FABRIC, 5, 10, 5, 20, 5),
    SKELETON("скелет", 70, 10, 0.9f, 0.9f, ITEM_TYPE.BONE, 5, 15, 5, 25, 5),
    GOBLIN("гоблин", 120, 10, 0.8f, 0.95f, ITEM_TYPE.DIAMOND, 1, 25, 7, 30, 5);
